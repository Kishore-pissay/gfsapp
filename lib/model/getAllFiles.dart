class GetAllFilesModel {
  int? respCode;
  List<RelatedRecordInfo>? relatedRecordInfo;
  RecordInfo? recordInfo;
  String? errorMsg;

  GetAllFilesModel(
      {this.respCode, this.relatedRecordInfo, this.recordInfo, this.errorMsg});

  GetAllFilesModel.fromJson(Map<String, dynamic> json) {
    respCode = json['respCode'];
    if (json['relatedRecordInfo'] != null) {
      relatedRecordInfo = [];
      json['relatedRecordInfo'].forEach((v) {
        relatedRecordInfo!.add(new RelatedRecordInfo.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.relatedRecordInfo != null) {
      data['relatedRecordInfo'] =
          this.relatedRecordInfo!.map((v) => v.toJson()).toList();
    }
...
class RelatedRecordInfo {
  ...
  RelatedRecordInfo({this.attributes, this.id, this.title, this.fileType});

  RelatedRecordInfo.fromJson(Map<String, dynamic> json) {
