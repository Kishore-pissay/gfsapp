                          ...
                          Column(
                            children: [
                              ...
                              UdyamiRegistrationDocumentUploadWidget(
                                  ...
                                  filename: StorageValues.udyamiRegBusiness,
                                  recID: recordId ?? ""),
                              SizedBox(height: 2.0),
                              UdyamiRegistrationDocumentUploadWidget(
                                  name: 'Owner Pan Card',
                              ...
                              SizedBox(height: 2.0),
                              UdyamiRegistrationDocumentUploadWidget(
                                  name: 'Bank Account Passbook first page',
                                  filename: StorageValues.udyamiRegBusiness,
                                  recID: recordId ?? ""),
                              SizedBox(height: 2.0),
                              UdyamiRegistrationDocumentUploadWidget(
                            ...
                            if (isSubmited)
                              Column(
                                children: [
                                  ...
                                  UdyamiRegistrationDocumentUploadWidget(
                                      name: 'Firm Pan Card',
                                      filename: StorageValues.udyamiRegFirm,
                                      recID: recordId ?? ""),
                                  SizedBox(height: 2.0),
                                  UdyamiRegistrationDocumentUploadWidget(
                                      name:
                              ...
                              Column(
                                children: [
                                  ...
                                  UdyamiRegistrationDocumentUploadWidget(
                                      ...
                                      filename: StorageValues.udyamiRegCompany,
                                      recID: recordId ?? ""),
                                  SizedBox(height: 2.0),
                                  UdyamiRegistrationDocumentUploadWidget(
